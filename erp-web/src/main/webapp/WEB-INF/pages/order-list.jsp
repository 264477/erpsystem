							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc sorting_asc_disabled">制单人</th>
										<th class="sorting_desc sorting_desc_disabled">制单时间</th>
										<th class="sorting">订单商品总量</th>
								...
								<tbody>
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="javascript:void(0);" onclick="delUser('${user.id}')" class="btn bg-olive btn-xs">详情</a>
											</td>
											<td>${user.phoneNum}</td>
											<td>${user.phoneNum}</td>
										</tr>
