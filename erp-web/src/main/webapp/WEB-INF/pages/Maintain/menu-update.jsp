...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<form action="${pageContext.request.contextPath}/maintenance/updatemenu" method="post">
			<!-- 正文区域 -->
					...
					<div class="row data-type">
						...
						<div class="col-md-10 data">
							<input type="text" class="form-control" name="url"
								   placeholder="菜单名称" value="${menu.url}">
						</div>
						...
						<div class="col-md-10 data">
							<c:forEach items="${rolelist}" var="role">
								<span>${role.name}<input value="${role.uuid}" type="checkbox" name="role"></span>
							</c:forEach>
						</div>--%>
