	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a
						href="${pageContext.request.contextPath}/user/findAll.do">部门</a></li>
		...
		<form action="${pageContext.request.contextPath}/maintenance/UpdateDep" method="post">
			<!-- 正文区域 -->
			<section class="content"> <!--产品信息-->
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						<input type="hidden" name="uuid" value="${updateDep.uuid}">
						<div class="col-md-2 title">部门名称</div>
						<div class="col-md-10 data">
							<input type="text" class="form-control" name="name"
								   placeholder="部门名称" value="${updateDep.name}">
						</div>

						<div class="col-md-2 title">电话</div>
						<div class="col-md-10 data">
							<input type="text" class="form-control" name="tele"
								   placeholder="电话" value="${updateDep.tele}">
						</div>
