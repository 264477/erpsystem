	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a
						href="${pageContext.request.contextPath}/user/findAll.do">员工</a></li>
		...
		<form action="${pageContext.request.contextPath}/maintenance/UpdateEmp" method="post">
			<!-- 正文区域 -->
			<section class="content"> <!--产品信息-->
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-10 data">
							<input type="text" class="form-control" name="pwd" value="${emp.pwd}">
						</div>
						...
						<div class="col-md-10 data">
							<select class="col-md-5 data" name="gender">
						...
						<div class="col-md-10 data">
							<input type="text" class="form-control" name="birthday"
								   placeholder="出生日期" value="${emp.birthday}">
						</div>
						...
						<div class="col-md-10 data">
							<input type="text" class="form-control" name="tele" value="${emp.tele}">
						</div>
						...
						<div class="col-md-10 data">
							<select class="col-md-5 data" name="depuuid">
						...
						<div class="col-md-10 data">
							<input type="text" class="form-control" name="lastlogintime" value="${emp.lastlogintime}">
						</div>
						<div class="col-md-2 title">最后登录IP地址</div>
						<div class="col-md-10 data">
							<input type="text" class="form-control" name="lastloginip" value="${emp.lastloginip}">
						</div>
						<div class="col-md-2 title">用户登录在线时间</div>
						<div class="col-md-10 data">
							<input type="text" class="form-control" name="logintimes" value="${emp.logintimes}">
						</div>

						<%--<div class="col-md-2 title">角色名称</div>
						<div class="col-md-10 data">
							<c:forEach items="${rolelist}" var="role">
								<span>${role.name}<input type="checkbox" name="roleid" value="${role.uuid}"></span>
							</c:forEach>
